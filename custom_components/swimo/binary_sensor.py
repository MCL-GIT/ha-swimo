# ============================================================================
# custom_components/swimo/binary_sensor.py
# ============================================================================
...
async def async_setup_entry(
    ...
    for alarm in alarms:
        alarm_num = alarm.get("alarm_index")
        if alarm_num:
...
class SwimoWebSocketSensor(CoordinatorEntity, BinarySensorEntity):
    ...
    def __init__(self, coordinator, api, entry_id):
        ...
        self._api = api
        self._attr_name = "Connexion Temps Réel"
...
class SwimoAlarm(CoordinatorEntity, BinarySensorEntity):
    ...
    def __init__(self, coordinator, alarm_data, entry_id):
        ...
        self._alarm_num = alarm_data.get("alarm_index")
        
        self._attr_name = alarm_data.get("alarm_name", f"Alarme {self._alarm_num}")
    ...
    def is_on(self):
        ...
        for alarm in alarms:
            if alarm.get("alarm_index") == self._alarm_num:
